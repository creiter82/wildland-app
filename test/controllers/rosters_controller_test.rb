...
class RostersControllerTest < ActionController::TestCase
  ...
  test "should create roster" do
    assert_difference('Roster.count') do
      post :create, roster: { end_time: @roster.end_time, name: @roster.name, start_time: @roster.start_time }
    end
  ...
  test "should update roster" do
    patch :update, id: @roster, roster: { end_time: @roster.end_time, name: @roster.name, start_time: @roster.start_time }
    assert_redirected_to roster_path(assigns(:roster))
  end
